...
# to replace the locked poistion existing color to shape color
...
def music(stop=0):
    if stop == 0:
        pygame.mixer.init()
        music_file = "sounds\etris-swing.flac"
...
def main():
    ...
    music_file = "sounds\game-over.flac"
    music_sound = pygame.mixer.Sound(music_file)
    music_sound.play()
